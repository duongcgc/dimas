...
class Dimas_Related_Posts {
	...
	public function __construct() {
		...
		// Related Post
		add_action( 'dimas_after_close_post_content', array( $this, 'related_post' ), 10 );

		add_action( 'dimas_after_open_related_post_contents', array( $this, 'related_heading' ), 10 );

		add_action( 'dimas_after_open_related_post_contents', array( $this, 'open_related_post' ), 20 );
		add_action( 'dimas_before_close_related_post_contents', array( $this, 'close_related_post' ), 50 );
	}
	...
	public function open_related_post() {
		...
		echo sprintf( '
					<div class="dimas-post__related-content swiper-container" data-columns="%s">
					<div class="dimas-post__related-content-inner swiper-wrapper">',
