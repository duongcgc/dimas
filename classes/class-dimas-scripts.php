<?php
/**
 * Dimas_Scripts functions and definitions.
 *
 * @package Dimas
 */
...
class Dimas_Scripts {
	...
	public function get_title() {
		...
		printf( // WPCS: XSS OK.
			esc_html( _nx( 'Dimas_Scripts (%1$s)', 'Dimas_Scripts (%1$s)', $comments_number, 'comments title', 'dimas' ) ),
	...
	public function comment_fields() {
		if ( ! comments_open() ) {
			echo '<p class="no-comments">' . esc_html__( 'Dimas_Scripts are closed.', 'dimas' ) . '</p>';
		} else {
	...
	/**
	 * Dimas_Scripts callback function
	 *
	 * @since 1.0.0
	 *
	...
	/**
	 * Dimas_Scripts Template function
	 *
	 * @since 1.0.0
	 *
	 * @param object $comment
