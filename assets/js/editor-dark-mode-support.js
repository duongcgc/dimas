/* global dimasIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'dimas-supports-dark-theme' ) ) {
	dimasDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function dimasDarkModeEditorInit( attempt ) {
	...
	if ( dimasIsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						dimasDarkModeEditorInit( attempt + 1 );
					},
