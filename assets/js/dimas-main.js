(function (t) {
    ...
    jQuery(".dimas-menu li").each(function () {
        jQuery(this).attr(
            "data-menuanchor",
            jQuery(this).text().charAt(0).toUpperCase() + jQuery(this).text().slice(1)
        );
        if (!jQuery("body.home").length) {
            jQuery(this)
                .find("a")
                .attr("href", "/" + jQuery(this).find("a").attr("href"));
    ...
    if (document.getElementById("coppy-link")) {
        document.getElementById("coppy-link").addEventListener("click", function () {
            var button_coppy = document.getElementById("coppy-link");
            var url_page = button_coppy.getAttribute("data-url-page");
            copyToClipboard(url_page);
        ...
        $(document).ready(function () {
            ...
            if ($(".dimas-sticky-share").length > 0) {
                function check_sticky() {
                    ...
                    var ticky_position =
                        element_top_position + element_height - 80 - end_sticky;
            ...
            function add_remove_class_header(header_size) {
                if ($(window).scrollTop() > header_size) {
                    if (!$(".dimas-navbar.dimas-navbar--main").hasClass(
                        "dimas-navbar--solid"
                    )) {
                        $(".dimas-navbar.dimas-navbar--main").addClass(
                            "dimas-navbar--solid"
                        );
                    }
                } else {
                    if (
                        $(".dimas-navbar.dimas-navbar--main").hasClass(
                            "dimas-navbar--solid"
                        )
                    ) {
                        $(".dimas-navbar.dimas-navbar--main").removeClass(
                            "dimas-navbar--solid"
                        );
                    }
                }
