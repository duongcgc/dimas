...
<?php endif; ?>
<?php echo '<a href="' . esc_url( wc_get_checkout_url() ) . '" class="button checkout wc-forward checkout_button rz-loop_atc_button rz-navigation-bar_icon">' . SVG_Icon::get_svg( 'checkout', '', 'mobile' ) .'<span class="checkout-text-button">' . esc_html__('Proceed to checkout', 'dimas') . '</span>' . '</a>'; ?>