...
<div class="modal-header">
    ...
    <a href="#"
       class="close-search-panel button-close"><?php echo GO_SVG_Icon::get_svg( 'close' ); ?></a>
</div>
        ...
        <div class="search-inner-content">
			...
			if ( Helper::get_option( 'header_search_type' ) == 'product' && taxonomy_exists('product_cat') ) {
				...
				echo sprintf(
					...
					GO_SVG_Icon::get_svg( 'chevron-bottom' ),
            ...
            <div class="search-wrapper">
				...
				<?php endif; ?>
                <a href="#"
                   class="close-search-results"><?php echo GO_SVG_Icon::get_svg( 'close' ); ?></a>
                <button class="search-submit"
                        type="submit"><?php echo GO_SVG_Icon::get_svg( 'search', '', 'shop' ); ?></button>
            </div>
        </div>
        <span class="razzi-loading"></span>
    </form>
	<?php GO_Header::search_quicklinks(); ?>
