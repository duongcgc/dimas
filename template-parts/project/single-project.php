							...
							<div class="swiper">
									...
									<div class="swiper-slide">
										...
										<div class="dimas-btn play-video">
											<svg width="24" height="28" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M1 1.87564L22 14L1 26.1244L1 1.87564Z" stroke="currentColor"
													stroke-width="2" />
											</svg>
										</div>
									</div>
								...
								<div class="swiper-button-prev">
									<svg width="20" height="36" viewBox="0 0 20 36" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M18.333 34L2.33301 18L18.333 2" stroke="currentColor" stroke-width="2"
											stroke-linecap="square" />
									</svg>
								</div>
								<div class="swiper-button-next">
									<svg width="20" height="36" viewBox="0 0 20 36" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M1.66699 34L17.667 18L1.66699 2" stroke="currentColor" stroke-width="2"
											stroke-linecap="square" />
									</svg>
								</div>
							</div>
								...
								<div class="swiper">
									<div class="swiper-wrapper">
										...
										<div class="swiper-slide">
											...
											<div class="thanks thanks-wrap mb-6 mb-md-96 d-flex align-items-center">
											...
											<div class="projects-pagination pb-32">
												<a class="projects-pagination__prev" href="##">
												Haloo Coffee
											</a>
												<a class="projects-pagination__next" href="##">
												Skyline Tower
											</a>
											</div>
										</div>
