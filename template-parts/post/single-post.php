			...
			<div class="dimas-blog">
				<div class="dimas-post">
					<div class="dimas-post__vertical-align">
						<img class="dimas-post__thumbnail" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/projects/bg-projects-1.png" alt="Post thumbnail">
						<div class="container py-8 pt-md-96 pt-md-96 pb-md-9">
							<div class="dimas-post-content-wrap row">
								...
								<div class="dimas-sticky-share d-none d-md-flex flex-wrap align-items-center px-0">
									<a class="dimas-sticky-share__item coppy-link" href="#">
									...
									<a class="dimas-sticky-share__item fb-share" href="#">
									...
									<a class="dimas-sticky-share__item tw-share" href="#">
