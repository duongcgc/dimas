					...
					<div class="container py-8 pt-md-96 pt-md-96 pb-md-9">
						<div class="dimas-post-content-wrap row">
							...
							<div class="dimas-sticky-share d-none d-md-flex flex-wrap align-items-center px-0">
								<a id="coppy-link" class="dimas-sticky-share__item coppy-link" data-url-page="<?php echo esc_url( $page_url ); ?>">
								...
								<a class="dimas-sticky-share__item fb-share" href="<?php echo esc_url( $facebook_url ); ?>" target="_blank">
								...
								<a class="dimas-sticky-share__item tw-share" href="<?php echo esc_url( $twitter_url ); ?>" target="_blank">
								...
								<a class="dimas-sticky-share__item email-share" href="mailto:?subject=<?php echo esc_html( $post_title ); ?>&body=<?php echo esc_url( $page_url ); ?>">
							...
							<div class="dimas-post-info col-md-8 mx-auto">
								...
								<div class="dimas-post__tag d-flex flex-wrap">
									...
									<?php foreach ( $arr_tags as $key => $value ) : ?>
										<a href="<?php echo esc_html( get_term_link( $value->term_id, 'post_tag' ) ); ?>">
											<p class="post-tag">
						...
						<div class="container">
							<div class="dimas-post-related-wrap d-flex flex-wrap justify-content-center">
								...
								<div class="dimas-grid-wrap d-grid">
									<?php
									foreach ( $related_post as $key => $blog ) :
										$related_post_id    = $blog->ID;
										$post_link          = get_post_permalink( $related_post_id );
										$post_thumbnail_url = get_the_post_thumbnail_url( $related_post_id );
										$post_date          = get_the_date( 'F j, Y', $related_post_id );
											...
											<div class="dimas-post__thumbnail dimas-post__thumbnail--wrap">
												<a class="dimas-post__link" href="<?php echo esc_url( $post_link ); ?>">
													...
													<div class="dimas-post__thumbnail dimas-post__thumbnail--arrow-wrap">
														<svg width="25" height="16" viewBox="0 0 25 16" fill="currentColor">
