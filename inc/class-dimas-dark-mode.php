...
class Dark_Mode {
	...
	public function customizer_controls( $wp_customize ) {
		...
		include_once get_theme_file_path( 'inc/core/customizer/class-dimas-customize-notice-control.php' ); // phpcs:ignore WPDimas_ThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
