...
final class GO_Theme {
	...
	public function dimas_includes() {
		...
		GO_Admin_Block_Editor::instance();
		...
		GO_Notice::instance()->add_notice( 'warning', 'This is best.', );
