...
class GO_Template_Function {
	...
	public function dimas_get_icon_svg( $group, $icon, $size = 24 ) {
		return \GO_SVG_Icons::get_svg( $group, $icon, $size );
	}
	...
	public function dimas_get_non_latin_css( $type = 'front-end' ) {
		...
		require_once get_theme_file_path( 'inc/class-dm-dynamic-css.php' ); // phpcs:ignore WPGO_ThemeReview.CoreFunctionality.FileInclude.FileIncludeFound				

		// Return the specified styles.
		return GO_Dynamic_CSS::dimas_generate_css( // @phpstan-ignore-line.
