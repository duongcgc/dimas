<?php
/**
 * Attachment functions and definitions.
 * => Processing media files image, thumbnail, video, pdf... attached inside content.
 *
 * @package Dimas
 */
...
class GO_Attachment {
	...
	public function get_title() {
		...
		printf( // WPCS: XSS OK.
			esc_html( _nx( 'Attachment (%1$s)', 'Attachment (%1$s)', $comments_number, 'comments title', 'dimas' ) ),
	...
	public function comment_fields() {
		if ( ! comments_open() ) {
			echo '<p class="no-comments">' . esc_html__( 'Attachment are closed.', 'dimas' ) . '</p>';
		} else {
