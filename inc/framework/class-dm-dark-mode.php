...
class DM_Dark_Mode {
	...
	public function customizer_controls( $wp_customize ) {
		...
		include_once get_theme_file_path( 'inc/core/customizer/class-dm-customize-notice-control.php' ); // phpcs:ignore WPDM_ThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
