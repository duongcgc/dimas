...
class GO_Dark_Mode {
	 ...
	 * @since Dimas 1.0
	 *
	 * @param WP_Customize_Manager $wp_customize GO_Theme Customizer object.
	 * @return void
	 */
	public function customizer_controls( $wp_customize ) {
		...
		include_once get_theme_file_path( 'inc/core/customizer/class-dm-customize-notice-control.php' ); // phpcs:ignore WPGO_ThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
	...
	public function the_script() {
		echo '<script>';
		include get_template_directory() . '/assets/js/dark-mode-toggler.js'; // phpcs:ignore WPGO_ThemeReview.CoreFunctionality.FileInclude
		echo '</script>';
	}
