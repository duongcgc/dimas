		...
		foreach ( $items as $item ) {
			...
			switch ( $item['item'] ) {
				...
				case 'text':
					...
					if ( $svg ) {
						$html_svg = '<span class="dimas-svg-icon">' . \Dimas\DM_SVG_Icons::sanitize_svg( $svg ) . '</span>';
					}
				...
				case 'close':
					echo esc_html( \Dimas\DM_SVG_Icons::get_svg( 'close', 'dimas-topbar__close', 32 ) );
					break;
		...
		foreach ( $items as $item ) {
			...
			switch ( $item['item'] ) {
				...
				case 'text':
					...
					if ( $svg ) {
						$html_svg = '<span class="dimas-svg-icon">' . DM_SVG_Icons::sanitize_svg( $svg ) . '</span>';
					}
				...
				case 'close':
					echo esc_html( DM_SVG_Icons::get_svg( 'close', 'dimas-topbar__close', 32 ) );
					break;
