...
class DM_Fw_Template_Tag {
	...
	public function dimas_entry_meta_footer() {
		...
		if ( ! is_single() ) {
			...
			if ( has_category() || has_tag() ) {
				...
				$categories_list = get_the_category_list( DM_Fw_Template_Function::wp_get_list_item_separator() );
				if ( $categories_list ) {
					printf(
				...
				$tags_list = get_the_tag_list( '', DM_Fw_Template_Function::wp_get_list_item_separator() );
				if ( $tags_list ) {
					printf(
	...
	public function dimas_post_thumbnail() {
		if ( ! \DM_Fw_Template_Function::instance()->dimas_can_show_post_thumbnail() ) {
			return;
		}
		?>
