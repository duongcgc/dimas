<?php
/**
 * Mobile Product Loop functions and definitions.
 *
 * @package Dimas
 */
...
class Product_Loop {
	...
	public function hooks() {
		add_filter( 'dimas_get_product_loop_layout', array( $this, 'get_product_loop_layout' ) );

		// add products class
		add_filter( 'woocommerce_product_loop_start', array( $this, 'loop_start' ), 5 );

		add_filter( 'dimas_get_product_loop_hover', array( $this, 'get_product_loop_hover' ));
	}
