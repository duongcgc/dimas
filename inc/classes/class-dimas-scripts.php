...
class Scripts {
	...
	public function get_title() {
		...
		printf( // WPCS: XSS OK.
			esc_html( _nx( 'Scripts (%1$s)', 'Scripts (%1$s)', $comments_number, 'comments title', 'dimas' ) ),
	...
	public function comment_fields() {
		if ( ! comments_open() ) {
			echo '<p class="no-comments">' . esc_html__( 'Scripts are closed.', 'dimas' ) . '</p>';
		} else {
