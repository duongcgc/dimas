...
class DM_Product_Authors {
	...
	public function __construct() {
		...
		$this->placeholder_img_src = DIMAS_ADDONS_URL . '/img/placeholder.png';
		// Add form
	...
	public function register_admin_scripts( $hook ) {
		...
		if ( $hook == 'edit-tags.php' && $screen->taxonomy == 'product_author' || $hook == 'term.php' && $screen->taxonomy == 'product_author' ) {
			wp_enqueue_media();
			wp_enqueue_script( 'rz_product_author_js', DIMAS_ADDONS_URL . "/assets/js/admin/author-taxes.js", array( 'jquery' ), '20190715', true );
		}
	}
