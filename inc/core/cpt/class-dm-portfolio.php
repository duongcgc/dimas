 ...
 * Class CPT_Portfolio.
 */
class DM_Portfolio extends CPT_Abstract {
	...
	public function create_taxonomy() {
		$labels         = array(
			'name'              => __( 'Categories', 'dimas' ),
			'singular_name'     => __( 'Category', 'dimas' ),
			'search_items'      => __( 'Search Category', 'dimas' ),
			'all_items'         => __( 'All Categories', 'dimas' ),
			'parent_item'       => __( 'Parent Category', 'dimas' ),
			'parent_item_colon' => __( 'Parent Category:', 'dimas' ),
			'edit_item'         => __( 'Edit Category', 'dimas' ),
			'update_item'       => __( 'Update Category', 'dimas' ),
			'add_new_item'      => __( 'Add New Category', 'dimas' ),
			'new_item_name'     => __( 'New Category Name', 'dimas' ),
			'menu_name'         => __( 'Categories', 'dimas' ),
		);
