...
class Mobile_Catalog {
	...
	public function hooks() {
		...
		add_action( 'woocommerce_before_shop_loop', array( \Dimas\GO_Theme::instance()->get( 'breadcrumbs' ), 'breadcrumbs' ) );
		...
		remove_action( 'woocommerce_before_shop_loop', array(
			\Dimas\GO_Theme::instance()->get( 'woocommerce' )->get_template( 'catalog' ),
	...
	public function page_header() {
		...
		if( in_array( 'breadcrumb', $items )) {
			\Dimas\GO_Theme::instance()->get( 'breadcrumbs' )->breadcrumbs();
		}
	...
	public function products_toolbar_filter() {
		...
		\Dimas\GO_Theme::instance()->set_prop( 'modals', 'filter' );
		?>
