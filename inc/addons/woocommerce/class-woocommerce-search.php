...
if (!class_exists('dimas_WooCommerce_Search')) :


    class dimas_WooCommerce_Search {
        public function __construct() {
            add_action('wp_ajax_dimas_woo_search', array($this, 'ajax_search_product'));
            add_action('wp_ajax_nopriv_dimas_woo_search', array($this, 'ajax_search_product'));
        }
        ...
        public function ajax_search_product() {
            ...
            if ($the_query->have_posts()) :
                ...
                <a class="button-link-search" href="<?php echo get_site_url() . '?s=' . esc_attr($_REQUEST['keyword']) . '&post_type=product'; ?>"><?php printf(__('Show All %s Results', 'dimas'), $the_query->found_posts); ?>
                    <i class="dimas-icon-arrow" aria-hidden="true"></i></a>
            <?php
            else:
                ?>
