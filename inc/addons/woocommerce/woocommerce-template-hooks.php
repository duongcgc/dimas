...
if (osf_is_woocommerce_extension_activated('YITH_WCWL')) {
    add_action('woocommerce_after_add_to_cart_form', 'osf_woocommerce_product_loop_wishlist_button', 15);
}
...
add_action('woocommerce_before_single_product_summary', 'osf_woocommerce_show_product_sale_flash_start', 5);
add_action('woocommerce_before_single_product_summary', 'osf_woocommerce_show_product_sale_flash_end', 99999);
...
function osf_include_hooks_product_blocks() {
    ...
    add_action('woocommerce_before_shop_loop_item_title', 'osf_woocommerce_get_product_label_new', 15);
    add_action('woocommerce_before_shop_loop_item_title', 'osf_woocommerce_get_product_label_stock', 20);
    add_action('woocommerce_before_shop_loop_item_title', 'osf_woocommerce_get_product_label_sale', 25);
    ...
    /**
     * Hook: osf_woocommerce_product_loop_action.
     */
    add_action('osf_woocommerce_product_loop_action', 'woocommerce_template_loop_add_to_cart', 25);
    // Wishlist
...
if (get_theme_mod('osf_woocommerce_product_style', 'grid') == 'list' || (isset($_GET['osf_woocommerce_product_style']) && $_GET['osf_woocommerce_product_style'] == 'list')) {
    remove_action('woocommerce_before_shop_loop_item_title', 'osf_woocommerce_product_loop_action', 40);
    add_action('woocommerce_after_shop_loop_item_title', 'woocommerce_template_single_excerpt', 15);
    add_action('woocommerce_after_shop_loop_item_title', 'osf_woocommerce_product_loop_action', 40);
}
...
if (get_theme_mod('osf_woocommerce_product_style', 'grid') == 'list' && isset($_GET['osf_woocommerce_product_style']) && $_GET['osf_woocommerce_product_style'] == 'grid') {
    ...
    remove_action('woocommerce_after_shop_loop_item_title', 'osf_woocommerce_product_loop_action', 40);
}
