...
class Module {
	...
	protected function add_actions() {
		if ( is_admin() ) {
			\Dimas\Addons\Modules\Related_Products\Settings::instance();

			if ( get_option( 'rz_custom_related_products' ) == 'yes' ) {
				\Dimas\Addons\Modules\Related_Products\Product_Options::instance();
			}
		}
	...
	public function template_hooks() {
		...
		if ( get_option( 'rz_related_products', 'yes' ) == 'yes' ) {
			\Dimas\Addons\Modules\Related_Products\Frontend::instance();
		} else {
