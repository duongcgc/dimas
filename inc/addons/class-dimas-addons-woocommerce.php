...
class Addons_Woocommerce {
	...
	public function get( $class ) {
		switch ( $class ) {
			case 'setup':
				return Woo_Setup::instance();
				break;
			case 'sidebars':
				return Woo_Sidebars::instance();
				break;
			case 'customizer':
				return Woo_Customizer::instance();
				break;
			case 'cache':
				return Woo_Cache::instance();
				break;
			case 'dynamic_css':
				return Woo_Dynamic_CSS::instance();
				break;
			case 'cat_settings':
				if ( is_admin() ) {
					return Woo_Settings_Category::instance();
				}
				break;

			case 'product_settings':
				if ( is_admin() ) {
					return Woo_Settings_Product::instance();
				}
				break;
		}
	}
	...
	public function get_template( $class ) {
		switch ( $class ) {
			case 'general':
				return Woo_Template_General::instance();
				break;
			case 'product_loop':
				return Woo_Template_Product_Loop::instance();
				break;
			case 'catalog':
				if ( Helper::is_catalog() ) {
					return Woo_Template_Catalog::instance();
				}
				break;
			case 'single_product':
				if ( is_singular( 'product' ) ) {
					return Woo_Template_Single_Product::instance();
				}
				break;
			case 'account':
				return Woo_Template_Account::instance();
				break;
			case 'cart':
				if ( function_exists( 'is_cart' ) && is_cart() ) {
					return Woo_Template_Cart::instance();
				}
				break;
			case 'checkout':
				if ( function_exists( 'is_checkout' ) && is_checkout() ) {
					return Woo_Template_Checkout::instance();
				}
				break;
			default:
				break;
	...
	public function get_element( $class ) {
		switch ( $class ) {
			case 'deal':
				return Woo_Elements_Product_Deal::instance();
				break;
			case 'masonry':
				return Woo_Elements_Product_Masonry::instance();
				break;
			case 'showcase':
				return Woo_Elements_Product_ShowCase::instance();
				break;
			case 'summary':
				return Woo_Elements_Product_Summary::instance();
				break;
			case 'product_with_thumbnails':
				return Woo_Elements_Product_With_Thumbnails::instance();
				break;
		}
	}
	...
	public function get_module( $class ) {
		switch ( $class ) {
			case 'badges':
				return Woo_Modules_Badges::instance();
				break;
			case 'quick_view':
				return Woo_Modules_Quick_View::instance();
				break;
			case 'notices':
				return Woo_Modules_Notices::instance();
				break;
			case 'recently_viewed':
				return Woo_Modules_Recently_Viewed::instance();
				break;
			case 'login_ajax':
				return Woo_Modules_Login_AJAX::instance();
				break;
			case 'mini_cart':
				return Woo_Modules_Mini_Cart::instance();
				break;
			case 'sticky_atc':
				if ( is_singular( 'product' ) && intval( apply_filters( 'dimas_product_add_to_cart_sticky', Helper::get_option( 'product_add_to_cart_sticky' ) ) ) ) {
					return Woo_Modules_Sticky_ATC::instance();
				}
				break;
		}
	}
