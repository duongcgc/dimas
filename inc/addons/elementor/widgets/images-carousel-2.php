...
class Images_Carousel_2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Dimas - Images Carousel', 'razzi' );
	}
	...
	protected function render() {
		...
		?>
			...
			<?php
				...
				echo \Dimas\Addons\Helper::get_svg('chevron-left','razzi-swiper-button-prev razzi-swiper-button');
				echo \Dimas\Addons\Helper::get_svg('chevron-right', 'razzi-swiper-button-next razzi-swiper-button');
				echo '</div>'
			?>
		</div>
		<?php
