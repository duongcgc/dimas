...
class Products_Listing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Dimas - Products Listing', 'dimas' );
	}
	...
	protected function section_content_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dimas-products-listing__heading',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing__heading' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing__heading' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'conditions' => [
					'terms' => [
						[
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing__heading' => 'margin-bottom: 0;',
					'{{WRAPPER}} .dimas-products-listing__heading--arrows' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'conditions' => [
					'terms' => [
						[
	...
	protected function section_carousel_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button-next' => 'right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button-prev' => 'left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dimas-products-listing__heading--arrows .dimas-products-listing__arrows' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dimas-products-listing__heading--arrows .dimas-products-listing__arrows .rz-swiper-button-prev' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .rz-swiper-button:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .swiper-pagination .swiper-pagination-bullet::before' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .swiper-pagination .swiper-pagination-bullet:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .dimas-products-listing .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active:before, {{WRAPPER}} .dimas-products-listing .swiper-pagination .swiper-pagination-bullet:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .dimas-products-listing .swiper-container-horizontal > .swiper-pagination-bullets .swiper-pagination-bullet' => 'margin-left: {{SIZE}}{{UNIT}}; margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .dimas-products-listing .swiper-pagination' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		$classes = [
			'dimas-products-listing dimas-swiper-carousel-elementor woocommerce dimas-swiper-slider-elementor',
			'navigation-' . $nav,
		...
		$title = $settings['heading'] ? sprintf('<div class="dimas-products-listing__heading">%s</div>', $settings['heading'] ) : '';

		$settings['columns'] = intval( $settings['slidesToShow'] );
		$products            = sprintf( '<ul class="dimas-products-listing__items products">%s</ul>', $this->get_categories_content( $settings ) );
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<?php printf( '<div class="dimas-products-listing__heading--arrows">%s<div class="dimas-products-listing__arrows">%s</div></div>%s', $title, $arrows, $products ); ?>
		</div>
		<?php
	}
	...
	protected function get_categories_content( $settings ) {
		...
		foreach ( $product_ids as $product_id ) {
			...
			$output[] = '<li class="dimas-products-listing__item product">';
			$output[] = '<a class="dimas-products-listing__item-box" href="'.get_permalink($product_id).'">';
			if( $image ) {
				$output[] = sprintf( '<img src="%s" class="dimas-products-listing__image">', $image );
			}
			$output[] = '<span class="dimas-products-listing__content">';
			$output[] = sprintf( '<span class="dimas-products-listing__title">%s</span>', $title );
			$output[] = sprintf( '<span class="dimas-products-listing__price price">%s</span>', $price );
			$output[] = '</span>';
			$output[] = '</a>';
			$output[] = '</li>';
		}
