...
class Controls {
	...
	public function includes() {
		\Dimas\Addons\Auto_Loader::register( [
				'Dimas\Addons\Elementor\Controls\AjaxLoader'  => DIMAS_ADDONS_DIR . 'inc/elementor/controls/class-dm-elementor-controls-ajaxloader.php',
				'Dimas\Addons\Elementor\Control\Autocomplete' => DIMAS_ADDONS_DIR . 'inc/elementor/controls/class-dm-elementor-autocomplete.php',
			]
		);
