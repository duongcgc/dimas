...
class Controls {
	...
	public function includes() {
		\Dimas\Addons\Auto_Loader::register( [
				'Dimas\Addons\Elementor\Controls\AjaxLoader'  => RAZZI_ADDONS_DIR . 'inc/elementor/controls/class-razzi-elementor-controls-ajaxloader.php',
				'Dimas\Addons\Elementor\Control\Autocomplete' => RAZZI_ADDONS_DIR . 'inc/elementor/controls/class-razzi-elementor-autocomplete.php',
			]
		);
