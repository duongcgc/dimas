...
class Socials_Walker extends \Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( str_contains( $url_name, 'google') ) {
			$url_name = 'google';
		} elseif ( str_contains( $url_name, 't.me') ) {
			$url_name = 'telegram';
		} elseif ( str_contains( $url_name, 'whatsapp') ) {
			$url_name = 'whatsapp';
		} elseif ( str_contains( $url_name, 'pinterest') ) {
			$url_name = 'pinterest';
		}
		...
		if( empty($item_svg_html) ) {
			$item_svg_html = \Dimas\Icon::get_svg( $url_name, '', 'social' );
		}
