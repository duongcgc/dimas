(function ($, _) {
    var DimasProductsFilterWidget = function () {
        var self = this;
    ...
    DimasProductsFilterWidget.prototype.initDropdowns = function (event, form) {
        if (!$.fn.select2) {
            return;
        }
    ...
    DimasProductsFilterWidget.prototype.initSliders = function (event, form) {
        $(document.body).trigger('init_price_filter');

        event.data.widget.removeSliderInputs(form);
    }

    DimasProductsFilterWidget.prototype.removeSliderInputs = function (form) {
        var $container = form ? $(form) : $('.products-filter-widget');

        $('.widget_price_filter', $container).find('input[type=hidden]').not('[name=min_price], [name=max_price]').remove();
    }

    DimasProductsFilterWidget.prototype.searchTerms = function (event) {
        var $this = $(this),
    ...
    DimasProductsFilterWidget.prototype.toggleCollapse = function (event) {
    ...
    DimasProductsFilterWidget.prototype.toggleItem = function (event) {
        event.preventDefault();
    ...
    DimasProductsFilterWidget.prototype.resetFilters = function () {
    ...
    DimasProductsFilterWidget.prototype.ajaxSearch = function (event) {
        event.data.widget.sendAjaxRequest(this);

        return false;
    }

    DimasProductsFilterWidget.prototype.instantSearch = function (event, form) {
    ...
    DimasProductsFilterWidget.prototype.updateURL = function (event, response, url, form) {
        var settings = $(form).data('settings');
    ...
    DimasProductsFilterWidget.prototype.updateForm = function (event, response, url, form) {
