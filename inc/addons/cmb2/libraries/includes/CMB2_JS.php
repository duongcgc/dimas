...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'dimas' ),
			'defaultString' => esc_html__( 'Default', 'dimas' ),
			'pick'          => esc_html__( 'Select Color', 'dimas' ),
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'dimas' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'dimas' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'dimas' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'dimas' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'dimas' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'dimas' ) ),
					'nextText'        => esc_html__( 'Next', 'dimas' ),
					'prevText'        => esc_html__( 'Prev', 'dimas' ),
					'currentText'     => esc_html__( 'Today', 'dimas' ),
					'closeText'       => esc_html__( 'Done', 'dimas' ),
					'clearText'       => esc_html__( 'Clear', 'dimas' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'dimas' ),
					'timeText'      => esc_html__( 'Time', 'dimas' ),
					'hourText'      => esc_html__( 'Hour', 'dimas' ),
					'minuteText'    => esc_html__( 'Minute', 'dimas' ),
					'secondText'    => esc_html__( 'Second', 'dimas' ),
					'currentText'   => esc_html__( 'Now', 'dimas' ),
					'closeText'     => esc_html__( 'Done', 'dimas' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'dimas' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'dimas' ),
				'upload_files' => esc_html__( 'Use these files', 'dimas' ),
				'remove_image' => esc_html__( 'Remove Image', 'dimas' ),
				'remove_file'  => esc_html__( 'Remove', 'dimas' ),
				'file'         => esc_html__( 'File:', 'dimas' ),
				'download'     => esc_html__( 'Download', 'dimas' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'dimas' ),
			),
		);
