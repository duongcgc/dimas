 ...
 */
function dimas_add_sub_menu_toggle( $output, $item, $depth, $args ) {
...
add_filter( 'walker_nav_menu_start_el', 'dimas_add_sub_menu_toggle', 10, 4 );
 ...
 */
function dimas_nav_menu_social_icons( $item_output, $item, $depth, $args ) {
...
add_filter( 'walker_nav_menu_start_el', 'dimas_nav_menu_social_icons', 10, 4 );
 ...
 * @return stdClass
 */
function dimas_add_menu_description_args( $args, $item, $depth ) {
...
add_filter( 'nav_menu_item_args', 'dimas_add_menu_description_args', 10, 3 );
